///esp8266 que esta en la cosina (boca de luz)/////////////
...
const char* ssid = "Fibertel WiFi550 2.4GHz";
const char* password = "1423231100";
...
int intervalo = 50000;   // intervalo del parpadeo (en milisegundos)
int grabatiempo = 0;
int automatico = 1;
