...
////Hora autoon cosina y comedor  17:20
if (hour()== horaprender  ){
...
////Automatico on / off comedor/////
    ...
    mando2=0;
    automaticocomedor=1;
    client.print(s + "Automatico comedor On");
    delay(50);
  }
  ...
  automaticocomedor=0;
   luz1prendida=0;
   luz2prendida=0;
   client.print(s + "Automatico comedor Off");
   delay(50);
  }
...
///////////////////este es nuevo tiempo de comedor aparte////////////////////////////
 ...
 luzcomedor1 = luces1estadoBuscada.toInt();   
  ...
  luzcomedor2 = luces2estadoBuscada.toInt();   
   ...
   client.println(s + "Checkbox Automatico"  + intervalo/1000 + valoranalogico + "controldeluz" + controldeluz + "entrada" + entrada + "automaticocomedor"+ automaticocomedor +"Cgrabatiemp=" + Cintervalo/1000 + " hora " +hour()+":"+minute());
    }

    else {
    client.println(s + "valor=11" + val + intervalo/1000 + "controldeluz" + controldeluz + "entrada" + entrada + "automaticocomedor"+ automaticocomedor);
...
else if (req.indexOf("controldeluz") != -1){
  String luzBuscada  = (req.substring(17,req.length()-9)); 
   controldeluz = luzBuscada.toInt();       
   if (automatico == 1) {
      
   // client.println(s + "Checkbox Automatico"  + intervalo/1000);
   client.println(s + "Checkbox Automatico"  + intervalo/1000 + valoranalogico + "controldeluz" + controldeluz + "entrada" + entrada + " hora " +hour()+":"+minute());
    }
